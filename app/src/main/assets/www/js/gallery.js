...
GALLERY.success_callback = function(response)
{
	...
	for(index in jsonImageArray)
	{
		...
		var template= '<div class="photobox">'+
			'<div class="photoinnner">'+
		'<img src="' +  photoObject.ImageData  + 
		'" class="phototile" onclick="GALLERY.image_click(\''+ photoObject.ImageData +'\');"/>'+
...
GALLERY.image_click = function(filepath)
{
	Wrapper.PreviewImage(filepath);
};
