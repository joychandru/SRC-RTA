...
NEWINCIDENT.setSessionValues = function(Category, Prefix)
{
	...
	{
		sessionStorage.parentPhotoPage = COMMON.SCREENS.NewIncident_Car; //Parent Page
...
{
alert("Location success," + response);
	if(response =="OFF")
	{
		alert("Switch ON GPS to update Location");
		var latitude="No Location";
...
$(document).ready(function()
{
	...
	COMMON.CurrentPage = COMMON.SCREENS.NewIncident_Car;
	
	//if(NEWINCIDENT.activeBox==1){$(".nav_left").hide();}	
	if(NEWINCIDENT.activeBox==8){$(".nav_right").hide();}
